...
alias update="bash ~/.config/scripts/update.sh"
alias install="yay -S"
...
alias configT="nvim .config/foot/foot.ini"
alias configZ="nvim .zshrc"
alias configW="nvim .config/waybar/config"
alias configS="nvim .config/waybar/style.css"
alias configL="nvim .config/hypr/hyprlock.conf"
